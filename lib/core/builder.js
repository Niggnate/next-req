...
const worker_1 = require("../common/utils/worker");
const path_transppend_1 = __importDefault(require("path-transppend"));
const MIN_STATUS = 200;
const MAX_STATUS = 300;
const MAX_STATUS_EXCEEDS = 303;
function builder(url, config) {
...
builder.create = (config) => {
    ...
    instance.get = (url, config) => {
        return instance.request(Object.assign({}, { url }, config, { method: 'get' }));
    };
    instance.post = (url, payload, config) => {
        return instance.request(Object.assign({}, { url }, config, { method: 'post', payload }));
    };
    instance.put = (url, payload, config) => {
        return instance.request(Object.assign({}, { url }, config, { method: 'put', payload }));
    };
    instance.delete = (url, payload, config) => {
        return instance.request(Object.assign({}, { url }, config, { method: 'delete', payload }));
    };
    instance.patch = (url, payload, config) => {
        return instance.request(Object.assign({}, { url }, config, { method: 'patch', payload }));
    };
    instance.options = (url, payload, config) => {
        return instance.request(Object.assign({}, { url }, config, { method: 'options', payload }));
    };
    instance.head = (url, payload, config) => {
        return instance.request(Object.assign({}, { url }, config, { method: 'head', payload }));
    };
    instance.connect = (url, payload, config) => {
        return instance.request(Object.assign({}, { url }, config, { method: 'connect', payload }));
    };
    instance.trace = (url, payload, config) => {
        return instance.request(Object.assign({}, { url }, config, { method: 'trace', payload }));
    };
    instance.interceptors = {
        request: (0, worker_1.addInterceptors)(),
        response: (0, worker_1.addInterceptors)()
    };
...
async function request(config) {
    ...
    let { url = '/', baseURL, method, headers, params = {}, payload, timeout, withCredentials, authenticate, validateStatus, paramsSerializer, generateRequest, generateResponse, redirect, responsePayloadType = 'json' } = config;
    // url and base url
    if (baseURL) {
        url = (0, path_transppend_1.default)(baseURL, url);
    }
    ////////////////////////////// [TODO]----------
    if (method) {
        if (worker_1.methods.indexOf(method.toLowerCase().trim()) === -1) {
    ...
    if (_params) {
        url = (0, path_transppend_1.default)(url, `?${_params}`);
    }
...
builder.get = (url, config) => {
    return builder.request(Object.assign({}, { url }, config, { method: 'get' }));
};
builder.post = (url, payload, config) => {
    return builder.request(Object.assign({}, { url }, config, { method: 'post', payload }));
};
builder.put = (url, payload, config) => {
    return builder.request(Object.assign({}, { url }, config, { method: 'put', payload }));
};
builder.delete = (url, payload, config) => {
    return builder.request(Object.assign({}, { url }, config, { method: 'delete', payload }));
};
builder.patch = (url, payload, config) => {
    return builder.request(Object.assign({}, { url }, config, { method: 'patch', payload }));
};
builder.options = (url, payload, config) => {
    return builder.request(Object.assign({}, { url }, config, { method: 'options', payload }));
};
builder.head = (url, payload, config) => {
    return builder.request(Object.assign({}, { url }, config, { method: 'head', payload }));
};
builder.connect = (url, payload, config) => {
    return builder.request(Object.assign({}, { url }, config, { method: 'connect', payload }));
};
builder.trace = (url, payload, config) => {
    return builder.request(Object.assign({}, { url }, config, { method: 'trace', payload }));
};
// Create interceptors
